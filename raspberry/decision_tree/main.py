...
BUTTON_PIN = 18
I2C_ADDR = 0x27
MODEL_PATH, CSV_LOG = "training/decision_tree/best/decision_tree_model.pkl", "milk_quality_log_dt.csv"
...
class MilkQualityDetector:
    def __init__(self):
        ...
        self.lcd.clear()
        self.lcd.write_string("DT Milk Quality")
    ...
    def process_detection(self):
        ...
        original_path = f"ori/original_dt_{self.image_counter}_{timestamp}.jpg"
        ...
        processed_path = f"pro/processed_dt_{self.image_counter}_{timestamp}.jpg"
        ...
        self.display_message(f"DT: {quality_text}", f"Time: {comp_time}s")
        time.sleep(3)
    ...
    def run(self):
        self.display_message("Press button", "for DT detect")
